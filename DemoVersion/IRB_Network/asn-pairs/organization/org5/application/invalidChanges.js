...
async function main(user1,user2,o1,o2) {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('invalid', o1+user1, o2+user2,userName);
        ...
        //console.log(`as Pair successfully invalidated for ASN Pair:  ${asPair.asn1} , ${asPair.asn2} `);
...
console.log(`Choosed Yaer : ${year}`);

async function processLineByLine() {
    const fileStream = fs.createReadStream('../../../../data/rel/changes/ripe/ripe_'+year+'_changes.csv');
