...
. ${PWD}/../test-network/scripts/utils.sh
  ...
  set -x
  fabric-ca-client register --caname ca-org1 --id.name asn1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://asn1:asn1pw@localhost:7054 --caname ca-org1 -M ${PWD}/../test-network/organizations/peerOrganizations/org1.example.com/users/Asn1@org1.example.com/msp --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/../test-network/organizations/peerOrganizations/org1.example.com/msp/config.yaml ${PWD}/../test-network/organizations/peerOrganizations/org1.example.com/users/Asn1@org1.example.com/msp/config.yaml
  ...
  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org2 --id.name asn2 --id.secret asn2pw --id.type client --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://asn2:asn2pw@localhost:8054 --caname ca-org2 -M ${PWD}/../test-network/organizations/peerOrganizations/org2.example.com/users/Asn2@org2.example.com/msp --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/../test-network/organizations/peerOrganizations/org2.example.com/msp/config.yaml ${PWD}/../test-network/organizations/peerOrganizations/org2.example.com/users/Asn2@org2.example.com/msp/config.yaml
  ...
  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org3 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org3/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the user msp"
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-org3 -M ${PWD}/../test-network/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org3/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/../test-network/organizations/peerOrganizations/org3.example.com/msp/config.yaml ${PWD}/../test-network/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/config.yaml
  ...
  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org4 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the user msp"
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:13054 --caname ca-org4 -M ${PWD}/../test-network/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp --tls.certfiles ${PWD}/../test-network/organizations/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/../test-network/organizations/peerOrganizations/org4.example.com/msp/config.yaml ${PWD}/../test-network/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp/config.yaml
