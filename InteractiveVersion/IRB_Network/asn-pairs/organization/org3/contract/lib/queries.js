...
class QueryUtils {
    ...
    * @param {String} asn1 the CP issuer
    * @param {String} asn2 commercial paper number
    */
    async getAssetHistory(asn1, asn2) {

        let ledgerKey = await this.ctx.stub.createCompositeKey(this.name, [asn1, asn2]);
                        ...
                        try {
                            ...
                            switch (jsonRes.Value.currentState) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    jsonRes.Value.currentState = 'VERIFIED';
                                    break;
                                case 2:
                                    jsonRes.Value.currentState = 'INVALID';
                                    break;
